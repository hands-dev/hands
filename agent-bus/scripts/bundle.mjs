#!/usr/bin/env node
/**
 * Build the committed plugin bundles: agent-bus/src/{server,cli}.ts →
...
const NODE_FLOOR_CHECK = (impl, extra = "") => `// generated by agent-bus/scripts/bundle.mjs — do not edit
...
export async function buildBundles(outDir = defaultOut) {
  ...
  fs.writeFileSync(
    ...
    NODE_FLOOR_CHECK("server-impl.mjs", 'process.env.AGENT_BUS_FORCE_MAIN = "1";\n'),
  );
