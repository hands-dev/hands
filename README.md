...
`/hands:hands` · `/hands:ready` · `/hands:line-check` · `/hands:install-cli` · `/hands:low-usage` · `/hands:normal-usage` skills,
and the
...
/hands:hands              # what's waiting on you — open to-dos + unanswered needs_human escalations
